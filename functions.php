...
function my_login_stylesheet() { ?>
    <link rel="stylesheet" id="custom_wp_admin_css"  href="<?php echo get_bloginfo( 'stylesheet_directory' ) . '/library/css/patternfly-blog.min.css'; ?>" type="text/css" media="all" />
<?php }
